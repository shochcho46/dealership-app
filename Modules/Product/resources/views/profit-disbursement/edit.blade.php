...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Profit Disbursement</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <form action="{{ route('admin.profitDisbursementUpdate', $disbursement->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <select class="form-control select2 @error('investor_id') is-invalid @enderror"
                                        ...
                                        @foreach($investors as $investor)
                                            <option value="{{ $investor->id }}"
                                                    {{ old('investor_id', $disbursement->investor_id) == $investor->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                           ...
                                           value="{{ old('disbursement_date', $disbursement->disbursement_date) }}"
                                           required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('note') is-invalid @enderror"
                                              ...
                                              name="note"
                                              rows="1"
                                              placeholder="Enter note">{{ old('note', $disbursement->note) }}</textarea>
                                    @error('note')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div id="investorInfo" class="row">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    <h6>Investor Information:</h6>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <strong>Total Investment:</strong> <span id="totalInvestment">৳ {{ number_format($disbursement->investor->total_investment, 2) }}</span>
                                        </div>
                                        <div class="col-md-6">
                                            <strong>Total Disbursed:</strong> <span id="totalDisbursed">৳ {{ number_format($disbursement->investor->total_disbursed_profit, 2) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
