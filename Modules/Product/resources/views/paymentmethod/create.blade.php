        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1 class="mt-3">Create New Payment Method</h1>
                    <div class="text-end">
                ...
                <div class="card card-primary card-outline mb-4">
                    ...
                    <form action="{{ route('admin.paymentMethodStore') }}" method="post">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary">
                                <span class="mdi mdi-content-save"></span> Save Payment Method
                            </button>
