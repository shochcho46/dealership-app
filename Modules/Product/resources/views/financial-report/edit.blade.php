...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">Edit Financial Report</h3>
            </div>
            <div class="col-sm-6">
...
<div class="app-content">
    <div class="container-fluid">
        <div class="card card-primary card-outline">
            ...
            <form action="{{ route('admin.financialReportUpdate', $financialReport) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <!-- Period Section -->
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date"
                                       ...
                                       id="start_date"
                                       name="start_date"
                                       value="{{ old('start_date', $financialReport->start_date->format('Y-m-d')) }}"
                                       required>
                                @error('start_date')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date"
                                       ...
                                       id="end_date"
                                       name="end_date"
                                       value="{{ old('end_date', $financialReport->end_date->format('Y-m-d')) }}"
                                       required>
                                @error('end_date')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       name="total_sales"
                                       step="0.01"
                                       value="{{ old('total_sales', $financialReport->total_sales) }}"
                                       placeholder="0.00"
                                       required>
                                @error('total_sales')
                                    <span class="invalid-feedback">{{ $message }}</span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       name="total_purchase"
                                       step="0.01"
                                       value="{{ old('total_purchase', $financialReport->total_purchase) }}"
                                       placeholder="0.00"
                                       required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       name="total_expense"
                                       step="0.01"
                                       value="{{ old('total_expense', $financialReport->total_expense) }}"
                                       placeholder="0.00"
                                       required>
                                @error('total_expense')
                                    <span class="invalid-feedback">{{ $message }}</span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       step="0.01"
                                       value="{{ old('total_lost_amount', $financialReport->total_lost_amount) }}"
                                       placeholder="0.00">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       step="0.01"
                                       value="{{ old('total_damage_amount', $financialReport->total_damage_amount) }}"
                                       placeholder="0.00">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       name="total_profit"
                                       step="0.01"
                                       value="{{ old('total_profit', $financialReport->total_profit) }}"
                                       placeholder="0.00"
                                       readonly>
                                @error('total_profit')
                                    <span class="invalid-feedback">{{ $message }}</span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       step="0.01"
                                       value="{{ old('profit_for_shareholders', $financialReport->profit_for_shareholders) }}"
                                       placeholder="0.00">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       step="0.01"
                                       value="{{ old('profit_for_sadaqah', $financialReport->profit_for_sadaqah) }}"
                                       placeholder="0.00">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       step="0.01"
                                       value="{{ old('profit_to_retain', $financialReport->profit_to_retain) }}"
                                       placeholder="0.00">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('remarks') is-invalid @enderror"
                                          ...
                                          name="remarks"
                                          rows="3"
                                          placeholder="Enter any additional notes">{{ old('remarks', $financialReport->remarks) }}</textarea>
                                @error('remarks')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-info">
                                <strong>Created By:</strong> {{ $financialReport->creator->name ?? 'System' }}
                                <br>
                                <strong>Created At:</strong> {{ $financialReport->created_at->format('d M Y h:i A') }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary">
                        <i class="mdi mdi-content-save"></i> Update Report
                    </button>
