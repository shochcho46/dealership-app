...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">Edit Company Order</h3>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Order Details - {{ $companyOrder->order_number }}</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.companyOrderUpdate', $companyOrder) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                    ...
                                    <select name="company_id" id="company_id" class="form-control select2" required>
                                        ...
                                        @foreach($companies as $company)
                                            <option value="{{ $company->id }}"
                                                {{ old('company_id', $companyOrder->company_id) == $company->id ? 'selected' : '' }}>
                                                {{ $company->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="notes" id="notes" class="form-control" rows="2">{{ old('notes', $companyOrder->notes) }}</textarea>
                                </div>
                            </div>
                                ...
                                <div class="product-item" data-index="{{ $index }}">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 mb-2">
                                            ...
                                            <input type="text" class="form-control measurement-unit" value="{{ $item->measurement_unit }}" readonly>
                                        </div>
                                        <div class="col-md-2 mb-2">
                                            <label class="form-label">Package Unit</label>
                                            <input type="text" class="form-control package-unit" value="{{ $item->package_unit }}" readonly>
                                        </div>
                                        <div class="col-md-2 mb-2">
                            ...
                            <hr>
                            <div class="text-end">
                                <h4>Total Amount: ৳<span id="total-amount">{{ number_format($companyOrder->total_amount, 2) }}</span></h4>
                            </div>
...
$(document).ready(function() {
    let itemIndex = {{ $companyOrder->items->count() }};
    let products = [];
