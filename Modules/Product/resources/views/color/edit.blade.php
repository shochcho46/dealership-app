        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1 class="mt-3">Edit Color: {{ $color->name }}</h1>
                    <div class="text-end">
                ...
                <div class="card card-primary card-outline mb-4">
                    ...
                    <form action="{{ route('admin.colorUpdate', $color) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="color" class="form-control form-control-color @error('code') is-invalid @enderror"
                                                   id="colorPicker" value="{{ old('code', $color->code) }}" style="width: 60px;">
                                            <input type="text" class="form-control @error('code') is-invalid @enderror"
                                                   id="code" name="code" placeholder="#000000"
                                                   value="{{ old('code', $color->code) }}" pattern="^#[a-fA-F0-9]{6}$" required>
                                            <div class="color-preview" id="colorPreview" style="background-color: {{ old('code', $color->code) }}"></div>
                                        </div>
                                        @error('code')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary">
                                <span class="mdi mdi-content-save"></span> Update Color
                            </button>
