...
class PaymentCollectionController extends Controller
{
    public function index(Request $request)
    {
        ...
        // $totalPending = Order::whereIn('payment_status', [0, 1])->sum('total_amount');
        // $pendingCollect = Order::whereIn('payment_status', [0, 1])->get()->sum(function($order) {
        //     $paidAmount = VendorAccount::where('order_id', $order->id)->where('type', 2)->sum('amount');
