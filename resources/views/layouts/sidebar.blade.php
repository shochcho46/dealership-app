            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-box-seam"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"> <a href="{{ route('admin.productIndex') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>All Products</p>
                            </a> </li>
                        <li class="nav-item"> <a href="{{ route('admin.productCreate') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Add Product</p>
                            </a> </li>
                        <li class="nav-item"> <a href="{{ route('admin.colorIndex') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Colors</p>
                            </a> </li>
                        <li class="nav-item"> <a href="{{ route('admin.unitIndex') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Units</p>
                            </a> </li>
                    </ul>
                </li>
                ...
                <!-- Stock Management -->
                <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-boxes"></i>
                        <p>
                            Stock Management
                            <i class="nav-arrow bi bi-chevron-right"></i>
                        </p>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"> <a href="{{ route('admin.stockIndex') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>All Stocks</p>
                            </a> </li>
                        <li class="nav-item"> <a href="{{ route('admin.stockCreate') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Add Stock</p>
                            </a> </li>
                        <li class="nav-item"> <a href="{{ route('admin.warehouseIndex') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Warehouses</p>
                            </a> </li>
                    </ul>
                </li>
                ...
                <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-people"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"> <a href="{{ route('admin.vendorIndex') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>All Vendors</p>
                            </a> </li>
                        <li class="nav-item"> <a href="{{ route('admin.vendorCreate') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Add Vendor</p>
                            </a> </li>
                    </ul>
                </li>
                ...
                <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-cart"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"> <a href="{{ route('orders.index') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>All Orders</p>
                            </a> </li>
                        <li class="nav-item"> <a href="{{ route('orders.create') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Create Order</p>
                            </a> </li>
                        <li class="nav-item"> <a href="{{ route('admin.orderStatusIndex') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Order Status</p>
                            </a> </li>
                    </ul>
                </li>
                ...
                <!-- Financial -->
                {{-- <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-cash-stack"></i>
                        <p>
                            Financial
                            <i class="nav-arrow bi bi-chevron-right"></i>
                        </p>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"> <a href="{{ route('payment-collections.index') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Payment Collection</p>
                            </a> </li>
                        <li class="nav-item"> <a href="{{ route('invoices.index') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Invoice Management</p>
                            </a> </li>
                        <li class="nav-item"> <a href="{{ route('admin.paymentMethodIndex') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Payment Methods</p>
                            </a> </li>
                    </ul>
                </li> --}}
                ...
                <!-- Reports & Issues -->
                <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-exclamation-triangle"></i>
                        <p>
                            Reports & Issues
                            <i class="nav-arrow bi bi-chevron-right"></i>
                        </p>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"> <a href="{{ route('damage-return-lost.index') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Damage/Return/Lost</p>
                            </a> </li>
                        <li class="nav-item"> <a href="{{ route('damage-return-lost.create') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Report Issue</p>
                            </a> </li>
                    </ul>
                </li>
