            ...
            <div class="row"> <!--begin::Col-->
                ...
                <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 2-->
                    <div class="small-box text-bg-success">
                        ...
                        {{-- <a href="{{ route('admin.account.index') }}" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover"> --}}
                            More info <i class="bi bi-link-45deg"></i> </a>
                ...
                <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 3-->
                    <div class="small-box text-bg-warning">
                        ...
                        {{-- <a href="{{ route('admin.account.index') }}" class="small-box-footer link-dark link-underline-opacity-0 link-underline-opacity-50-hover"> --}}
                            More info <i class="bi bi-link-45deg"></i> </a>
